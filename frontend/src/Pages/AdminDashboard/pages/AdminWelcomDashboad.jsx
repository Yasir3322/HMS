  ...
  return (
    <div className="w-full">
      <div className="flex rounded-lg gap-2 align-middle items-center bg-[#e2f0f9] p-5 w-full dark:bg-slate-800">
        ...
        <p className="font-serif">Welcome to Admin Dashboard</p>
      </div>

      <div className="border border-gray-300 mt-2 rounded-2xl">
        <h1 className="font-serif pl-6 py-6">Dashboard all statistics</h1>
